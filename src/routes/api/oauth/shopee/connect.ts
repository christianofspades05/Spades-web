/**
 * Starts the Shopee OAuth connect flow. Staff clicks "Connect" on the admin
 * Channels page, which links here; this redirects to Shopee's own
 * authorization screen. Shopee redirects back to callback.ts once the
 * seller approves.
 *
...
export const Route = createFileRoute('/api/oauth/shopee/connect')({
  server: {
    handlers: {
      GET: async () => {
