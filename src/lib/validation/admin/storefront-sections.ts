...
export const storefrontSectionInputSchema = z
  .object({
    ...
    titleJa: z.string().trim().max(200).optional(),
    titleKo: z.string().trim().max(200).optional(),
    titleZh: z.string().trim().max(200).optional(),
    subtitle: z.string().trim().max(2000).optional(),
    subtitleJa: z.string().trim().max(2000).optional(),
    subtitleKo: z.string().trim().max(2000).optional(),
    subtitleZh: z.string().trim().max(2000).optional(),
